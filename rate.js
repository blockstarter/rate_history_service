...
(function(){
  var request, moment, p, big, buildUrl, eachMinuteQuarter, roundMinuteQuarterTrade, roundMinuteQuarter, observers, notify, $off, $on, dateToTs, calcAvgTrade, calcAvg, aggregate, calcAllAvgs, loadRates, uploadRates, rateIndex, getRateIndex, setRateIndex, createRateIndex, getRate, getRateByPair, getOrLoadRate, out$ = typeof exports != 'undefined' && exports || this, toString$ = {}.toString;
